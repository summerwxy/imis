    ...
    <div class="span10 offset1">
        ...
        <form class="form-horizontal" method="POST" action="add">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="person" type="text" value="" class="input-xxlarge">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">地址</label>
                <div class="controls">
                    <input name="address" type="text" value="" class="input-xxlarge">
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls input-append date form_datetime" data-date-format="yyyy/mm/dd" style="margin-left: 20px;">
                    <input name="sdate" class="input-small" type="text" value="" readonly>
            ...
            <div class="control-group">
                ...
                <div class="controls input-append date form_datetime" data-date-format="yyyy/mm/dd" style="margin-left: 20px;">
                    <input name="edate" class="input-small" type="text" value="" readonly>
                    <span class="add-on"><i class="icon-th"></i></span>
                </div>                
            </div>
            <div class="control-group">
                ...
                <div class="controls input-append date form_datetime" data-date-format="yyyy/mm/dd" style="margin-left: 20px;">
                    <input name="cdate" class="input-small" type="text" value="" readonly>
                    <span class="add-on"><i class="icon-th"></i></span>
                </div>                
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="man" type="text" value="" class="input-xxlarge">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">电话号码</label>
                <div class="controls">
                    <input name="tel" type="text" value="" class="input-xxlarge">
                </div>
            </div>
            <div class="control-group">
