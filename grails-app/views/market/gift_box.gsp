                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <form name="sentMessage" id="payForm" novalidate>
                            ...
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    <label>送货地址</label>
                                    <textarea rows="5" class="form-control" placeholder="（限江浙沪皖）例：江苏省苏州市吴中区石湖西路159号" id="address" name="address" required data-validation-required-message="请输入送货地址">${address}</textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
