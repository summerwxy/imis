...
<html lang="en">
	<head>
		...
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="${resource(dir: 'themes/css', file: 'ace-ie.min.css')}" />
		<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${resource(dir: 'themes/js', file: 'jquery-1.9.1.min.js')}'>"+"<"+"/script>");
		</script>
		<script src="${resource(dir: 'bootstrap/js', file: 'bootstrap.min.js')}"></script>
		<script src="${resource(dir: 'themes/js', file: 'jquery-ui-1.10.3.custom.min.js')}"></script>
												...
												<div id="member-tab" class="tab-pane">
													<div class="clearfix">
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Bob Doe's avatar" src="${resource(dir: 'themes/images', file: 'user.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Joe Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar2.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Jim Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Alex Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar2.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Bob Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar2.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Susan's avatar" src="${resource(dir: 'themes/images', file: 'avatar3.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Phil Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar4.png')}" />
															</div>
														...
														<div class="itemdiv memberdiv">
															<div class="user">
																<img alt="Alexa Doe's avatar" src="${resource(dir: 'themes/images', file: 'avatar1.png')}" />
															</div>
												...
												<div id="comment-tab" class="tab-pane">
													<div class="comments">
														<div class="itemdiv commentdiv">
															<div class="user">
																<img alt="Bob Doe's Avatar" src="${resource(dir: 'themes/images', file: 'avatar.png')}" />
															</div>
														...
														<div class="itemdiv commentdiv">
															<div class="user">
																<img alt="Jennifer's Avatar" src="${resource(dir: 'themes/images', file: 'avatar1.png')}" />
															</div>
														...
														<div class="itemdiv commentdiv">
															<div class="user">
																<img alt="Joe's Avatar" src="${resource(dir: 'themes/images', file: 'avatar2.png')}" />
															</div>
														...
														<div class="itemdiv commentdiv">
															<div class="user">
																<img alt="Rita's Avatar" src="${resource(dir: 'themes/images', file: 'avatar3.png')}" />
															</div>
										...
										<div class="widget-main no-padding">
											<div class="dialogs">
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Alexa's Avatar" src="${resource(dir: 'themes/images', file: 'avatar1.png')}" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="John's Avatar" src="${resource(dir: 'themes/images', file: 'avatar.png')}" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Bob's Avatar" src="${resource(dir: 'themes/images', file: 'user.png')}" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Jim's Avatar" src="${resource(dir: 'themes/images', file: 'avatar4.png')}" />
													</div>
